...
//        getMenuInflater().inflate(R.menu.menu_pictures, menu);
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public CharSequence getPageTitle(int position) {
            switch (position) {
                case 0:
                    return getString(R.string.action_recommended);
                case 1:
                    return getString(R.string.action_hot);
                case 2:
                    return getString(R.string.action_start_page);
                case 3:
                    return getString(R.string.action_newest);
                case 4:
                    return getString(R.string.action_2k);
            }
            return null;
        }
    }
